...
{
    public class CriarPlanoIADTOValidator : AbstractValidator<CriarPlanoIADTO>
    {
        public CriarPlanoIADTOValidator()
        {
            RuleFor(x => x.Titulo)
            ...
            RuleFor(x => x.HorasPorSemana)
                .GreaterThan(0).WithMessage("As horas por semana devem ser maiores que zero.")
